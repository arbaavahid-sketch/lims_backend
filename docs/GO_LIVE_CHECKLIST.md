...
- [x] ارسال خودکار ایمیل جواب/لینک هنگام «بستن» درخواست فعال شد (فاز ۷).
      فرم عمومی حالا ایمیل/تلفن مشتری را می‌گیرد و هنگام بستن، پاسخ + لینک
      اختصاصی خودکار ایمیل می‌شود. (تست سرتاسری موفق؛ تحویل واقعی به Inbox را
      یک‌بار با ایمیل خودتان امتحان کنید.)
