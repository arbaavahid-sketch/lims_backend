# -*- coding: utf-8 -*-
# Auto-generated: Analysis-Service Keyword -> final method/standard string for
# the analysis report (Tandis / TPPC). Built from the reviewed master data
# (161 services, 6 ASTM corrections applied). Do not hand-edit; regenerate.
METHOD_STANDARDS = {
